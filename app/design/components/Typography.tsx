    ...
    <div>
      ...
      <div className="mb-12">
        ...
        <div className="bg-gray-50 p-6 rounded-lg">
          ...
          <p style={{ fontFamily }} className="text-2xl">
            Inter
          </p>
      ...
      <div className="mb-12">
        ...
        <div className="space-y-8">
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <h1 className="text-5xl font-bold">Heading Level 1</h1>
          </div>
          
          <div className="bg-gray-50 p-6 rounded-lg">
            <p className="mb-2 text-xs text-gray-500">h2 / 30px / font-bold</p>
            <h2 className="text-4xl font-bold">Heading Level 2</h2>
          </div>
          
          <div className="bg-gray-50 p-6 rounded-lg">
            <p className="mb-2 text-xs text-gray-500">h3 / 24px / font-bold</p>
            <h3 className="text-3xl font-bold">Heading Level 3</h3>
          </div>
          
          <div className="bg-gray-50 p-6 rounded-lg">
            <p className="mb-2 text-xs text-gray-500">h4 / 20px / font-bold</p>
            <h4 className="text-2xl font-bold">Heading Level 4</h4>
          </div>
          
          <div className="bg-gray-50 p-6 rounded-lg">
            <p className="mb-2 text-xs text-gray-500">h5 / 18px / font-bold</p>
            <h5 className="text-xl font-bold">Heading Level 5</h5>
          </div>
          
          <div className="bg-gray-50 p-6 rounded-lg">
            <p className="mb-2 text-xs text-gray-500">h6 / 16px / font-bold</p>
            <h6 className="text-lg font-bold">Heading Level 6</h6>
          </div>
