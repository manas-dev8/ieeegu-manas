...
export async function generateMetadata({ params }: OrganizationPageProps): Promise<Metadata> {
  ...
  return {
    title: `${organization.name} | IEEE GU Blog`,
      ...
      <div className="max-w-4xl mx-auto mb-12">
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {organization.authors.map((author: {_id: string, slug: string, name: string, image?: any}) => (
                <Link 
                  key={author._id} 
      ...
      {organization.posts && organization.posts.length > 0 ? (
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {organization.posts.map((post: any) => (
